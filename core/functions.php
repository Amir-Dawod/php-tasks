...
function createProduct($title, $price, $imageName, $imageTmpName, $imageSize)
{
    ...
    uploadImage($imageName, $imageTmpName);
    $oldProducts[] = $product;
...
function editProduct($id, $title, $price, $imageName, $imageTmpName, $imageSize)
{
    ...
    foreach ($allProducts as &$product) {
        if ($product['id'] == $id) {
            $product['title'] = $title;
            $product['price'] = $price;
            $product['imageName'] = $imageName == "" ? $product['imageName'] : $imageName;
            $product['imageTmpName'] = $imageTmpName == "" ? $product['imageTmpName']  :  $imageTmpName;
            $product['imageSize'] = $imageSize == "" ? $product['imageSize'] : $imageSize;
        }
    }
