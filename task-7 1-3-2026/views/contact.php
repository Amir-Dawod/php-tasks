         ...
         <div class="bg-light rounded-4 py-5 px-4 px-md-5">
             ...
             <div class="row gx-5 justify-content-center">
                 <div class="col-lg-8 col-xl-6">
                     ...
                     <?php if ($error = showMessage()): ?>
                         <?= $error ?>
                     <?php endif; ?>
                     <form action="../handle/handle.php" method="post" id="contactForm">
                         <!-- Name input-->
                         ...
                         <select class="form-select mb-3" aria-label="Default select example" id="country">
                         ...
                         <!-- Phone input-->
                         <div class="form-floating mb-3">
                             <input class="form-control" id="phone" type="tel" name="phone" value="+20" placeholder="(123) 456-7890" />
